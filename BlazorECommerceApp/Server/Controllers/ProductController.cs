...
namespace BlazorECommerceApp.Server.Controllers
{
    ...
    {
        private readonly BlazorECommerceDbContext _blazorECommerceDbContext;

        public ProductController(BlazorECommerceDbContext blazorECommerceDbContext)
        {
            _blazorECommerceDbContext = blazorECommerceDbContext;
        }
        ...
        {
           var products = await _blazorECommerceDbContext.Products.ToListAsync();   
            return Ok(products);
        }
